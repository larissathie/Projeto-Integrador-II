...
def test_processar_reserva_json_ok(sessao_logada):
    # Formato que seu endpoint espera: "Mon Jan 06 2025 10:00:00 GMT-0300"
    ...
    assert body["data_convertida"] == "06/01/2025"

def test_processar_reserva_sem_json(sessao_logada):
    resp = sessao_logada.post("/processar-reserva", data="sem json")
